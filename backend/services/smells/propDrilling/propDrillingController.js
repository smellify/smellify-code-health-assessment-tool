...
// // services/propDrilling/propDrillingController.js
// const glob = require('fast-glob');
// const { extractDefsAndUses } = require('./defUseAnalyzer');    // replaces astParser
// const { buildComponentMap } = require('./componentMapper');
// const { buildDUChains, detectDrillingFromDUChains, getDUChainStats } = require('./duChainBuilder'); // replaces chainBuilder
...
//     // STEP 1: Extract DEFs and USEs from every file (replaces parseReactFile)
...
//     // STEP 3: Build DU chains (replaces buildAllPropChains)
...
//     // STEP 4: Detect drilling from DU chains (replaces detectPropDrilling)
...
//     return {
//       stats: { totalFiles: stats.totalFiles, totalComponents: stats.totalComponents, filesWithErrors: stats.filesWithErrors },
